...
from apps.reservas.views import agenda,reservas,reservas_produto,reservas_servico,editar_reserva_produto,\
    editar_reserva_servico,deletar_reserva_produto,deletar_reserva_servico,nova_reserva_produto,nova_reserva_servico
...
urlpatterns = [
    ...
    path('nova-reservas-produto/<int:id>', nova_reserva_produto, name='nova-reservas-produto'),
    path('nova-reservas-servico/<int:id>', nova_reserva_servico, name='nova-reservas-servico'),
