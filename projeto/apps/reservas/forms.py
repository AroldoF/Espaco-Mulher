...
class ReservaProdutoForms(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            "data_reservada": forms.DateTimeInput(attrs={'class': 'form-control', 'type': 'datetime-local'}),  # Aqui!
        }
...
class ReservaServicoForms(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            "data_reservada": forms.DateTimeInput(attrs={'class': 'form-control', 'type': 'datetime-local'}),  # Aqui também!
        }
